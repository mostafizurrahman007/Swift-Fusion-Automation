...
class OldSwift_Camt_029_Page {
    ...
    inputFromBIC(){
        ...
        commonLocators.inputByPlaceholder("Enter SWIFT code prefix to search...").clear().type("M");
        commonLocators.ByAria_Label_Btn("Find SWIFT Code").should('be.visible').click();
    ...
    fromClearingSystemID(){
        commonLocators.inputByPlaceholder(" Search clearing system id code").eq(0).click();
        commonLocators.ByTextWithTag('div', ' VA - VaticanCityClearingSystemID ').should('be.visible').click();
    }

    toClearingSystemID(){
        commonLocators.inputByPlaceholder(" Search clearing system id code").eq(1).click();
        commonLocators.ByTextWithTag('div', ' VA - VaticanCityClearingSystemID ').should('be.visible').click();
    }

    assignerClearingSystemID(){
        commonLocators.inputByPlaceholder(" Search clearing system id code").eq(2).click();
        commonLocators.ByTextWithTag('div', ' VA - VaticanCityClearingSystemID ').should('be.visible').click();
    }

    assigneeClearingSystemID(){
        commonLocators.inputByPlaceholder(" Search clearing system id code").eq(3).click();
        commonLocators.ByTextWithTag('div', ' VA - VaticanCityClearingSystemID ').should('be.visible').click();
    }
    ...
    fromLei(){
        commonLocators.ByControlName('fromLei').clear().type('11111111111111111111');
    }
    ...
    assignerLei(){
        commonLocators.ByControlName('assgnrLei').clear().type('11111111111111111111');
    }

    assigneeLei(){
        commonLocators.ByControlName('assgneLei').clear().type('11111111111111111111');
    }

    copyDuplicateField(){
        commonLocators.inputByPlaceholder(" Search copy duplicate").click();
        commonLocators.ByTextWithTag('div', ' COPY - Copy ').should('be.visible').click();
    }
    ...
    relatedCharacterSetField(){
        commonLocators.ByTextWithTag('span', 'Related Information').should('be.visible').click();
        commonLocators.ByControlName('rltdCharSet').clear().type('A')
    }

    relatedFromBIC(){
        // commonLocators.ByTextWithTag('span', 'From').eq(5).should('be.visible').click();
        commonLocators.ByControlName("rltdFrBicfi").scrollIntoView({force:true}).dblclick();
        commonLocators.inputByPlaceholder("Enter SWIFT code prefix to search...").clear().type("M");
        commonLocators.ByAria_Label_Btn("Find SWIFT Code").should('be.visible').click();
        commonLocators.ByTextWithTag('td', ' MUTUAL TRUST BANK LTD.').dblclick();
    }
    ...
    assignmentIdentificationField(){
        commonLocators.ByControlName("assgnmtId").should('be.visible').clear().type("1");
    }

    assignerBIC(){
        commonLocators.ByControlName("assgnrBicfi").dblclick();
        commonLocators.inputByPlaceholder("Enter SWIFT code prefix to search...").clear().type("M");
        commonLocators.ByAria_Label_Btn("Find SWIFT Code").click().should('be.visible');
        commonLocators.ByTextWithTag('td', ' MUTUAL TRUST BANK LTD.').dblclick();
    }

    confirmationDialog(){
        commonLocators.inputByPlaceholder(" Search confirmation").click();
        commonLocators.ByTextWithTag('div', 'CNCL - Cancellation Confirmed').should('be.visible').click();
    }


    cancellationStatusID(){
        commonLocators.ByControlName("cxlStsId").should('be.visible').clear().type("1");
    }

    caseIdentificationField(){
        commonLocators.ByControlName("caseId").should('be.visible').clear().type("1");
    }

    creatorTypeField(){
        commonLocators.inputByPlaceholder(" Search creator type").click();
        commonLocators.ByTextWithTag('div', ' Agent (Financial Institution) ').should('be.visible').click();
    }
    ...
    originalMsgId(){
        commonLocators.ByControlName("orgnlMsgId").should('be.visible').clear().type("A");
    }

    originalMsgNameId(){
        commonLocators.ByControlName("orgnlMsgNmId").should('be.visible').clear().type("A");
    }

    UETR(){
        commonLocators.ByControlName("orgnlUetr").should('be.visible').clear().type("de2da6c9-18be-48d4-8053-867ed90a316a");
    }

    save(){
        commonLocators.ByTextWithTag('p', 'Save').should('be.visible').click({force:true})
